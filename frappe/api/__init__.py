...
import nts
from nts import _
from nts.modules.utils import get_doctype_app_map
from nts.monitor import add_data_to_monitor
from nts.utils.response import build_response
from nts.utils.telemetry.pulse.app_heartbeat_event import capture_app_heartbeat
...
def handle(request: Request):
	...
	if nts.get_system_settings("log_api_requests"):
		doc = nts.get_doc(
			{
	...
	with suppress(Exception):
		method = arguments.get("method") or nts.form_dict.get("method")
		doctype = arguments.get("doctype") or nts.form_dict.get("doctype")
