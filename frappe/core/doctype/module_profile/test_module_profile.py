...
class TestModuleProfile(IntegrationTestCase):
	def setUp(self):
		nts.delete_doc_if_exists("Module Profile", "_Test Module Profile", force=1)
		nts.delete_doc_if_exists("Module Profile", "_Test Module Profile 2", force=1)
		nts.delete_doc_if_exists("User", "test-module-user1@example.com", force=1)
		nts.delete_doc_if_exists("User", "test-module-user2@example.com", force=1)
