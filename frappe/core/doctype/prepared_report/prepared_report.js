		...
		if (frm.doc.status == "Completed") {
			...
			if (!csv_attached) {
				frm.add_custom_button(__("Download as CSV"), function () {
					nts.call({
						method: "nts.core.doctype.prepared_report.prepared_report.enqueue_json_to_csv_conversion",
						args: {
			...
			frm.add_custom_button(__("Cancel Prepared Report"), () => {
				nts.confirm(
					...
					() => {
						nts
							.xcall(
								"nts.core.doctype.prepared_report.prepared_report.stop_prepared_report",
								{
