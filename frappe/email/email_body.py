...
class EMail:
	...
	def add_headers(self, headers):
		...
		if not isinstance(headers, dict):
			nts.throw(_("Headers must be a dictionary"))
...
def get_formatted_html(
	...
	if raw_html:
		rendered_email = nts.render_template(message, params)
	else:
		params.update(
			{
		...
		rendered_email = nts.get_template("templates/emails/standard.html").render(params)
