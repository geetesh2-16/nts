...
"""Query implementation using nts's query builder"""
...
import nts
from nts.database.utils import DefaultOrderBy, FilterValue
...
class DatabaseQuery:
	...
	def execute(
		...
		*,
		...
		kwargs = {
			...
			"group_by": group_by,
			"order_by": order_by,
			"limit": nts.cint(limit),
			"offset": nts.cint(offset),
			"distinct": distinct,
	...
	def _handle_virtual_doctype(
		...
		from nts.types.filter import Filters
		...
		# Use nts.call to filter kwargs and call controller
