			...
			<template #actions>
				<div class="field-actions" :hidden="store.read_only">
					<button
						...
						@click="edit_filters"
					>
						<div v-html="nts.utils.icon('filter', 'sm')" />
					</button>
					...
					>
						<div v-html="nts.utils.icon('move', 'sm')" />
					</button>
					<button
						class="btn btn-xs btn-icon"
					...
					>
						<div v-html="nts.utils.icon('duplicate', 'sm')" />
					</button>
					<button
					...
					>
						<div v-html="nts.utils.icon('external-link', 'sm')" />
					</button>
					<button
						class="btn btn-xs btn-icon"
					...
					>
						<div v-html="nts.utils.icon('remove', 'sm')" />
					</button>
				</div>
			</template>
		</component>
