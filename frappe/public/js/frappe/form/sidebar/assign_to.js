...
nts.ui.form.AssignTo = class AssignTo {
	...
	render(assignments) {
		...
		let assignment_group = new nts.ui.form.AssignmentClass({
...
nts.ui.form.AssignmentClass = class AssignmentClass {
	constructor(opts) {
		this.frm = opts.frm;
...
nts.ui.form.AssignmentDialog = class extends nts.ui.form.AssignmentClass {
	constructor(opts) {
		super(opts);
		this.make();
	}
