...
to provide custom formatting and logging for test results in the nts framework.
...
test results during test execution in the nts framework.
"""
...
class TestResult(unittest.TextTestResult):
	...
	def startTestRun(self):
		if not sys.warnoptions:
			...
			from nts.deprecation_dumpster import ntsDeprecationWarning

			warnings.simplefilter("ignore")
			warnings.filterwarnings("module", category=ntsDeprecationWarning)
...
class ntsTestResult(unittest.TextTestResult):
	def __init__(self, stream, descriptions, verbosity):
		super().__init__(stream, descriptions, verbosity)
