...
from nts.utils import cint, get_test_client, get_url
...
class ntsAPITestCase(IntegrationTestCase):
...
class TestResourceAPI(ntsAPITestCase):
	...
	def tearDownClass(cls):
		...
		nts.delete_doc_if_exists("User", cls.TEST_USER)
		nts.db.commit()
...
class TestAPIResponse(ntsAPITestCase):
