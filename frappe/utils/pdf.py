...
cssutils.log.setLog(nts.logger("cssutils"))
...
def get_chrome_pdf(print_format, html, options, output, pdf_generator=None):
	from nts.utils.pdf_generator.browser import Browser
	from nts.utils.pdf_generator.chrome_pdf_generator import ChromePDFGenerator
	from nts.utils.pdf_generator.pdf_merge import PDFTransformer
