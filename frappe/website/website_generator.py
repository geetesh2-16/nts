...
class WebsiteGenerator(Document):
	...
	def clear_cache(self):
		...
		nts.db.after_commit.add(lambda: clear_cache(self.route))
		nts.db.after_rollback.add(lambda: clear_cache(self.route))
	...
	def remove_old_route_from_index(self):
		...
		if self.allow_website_search_indexing() or nts.in_test:
			return
	...
	def update_website_search_index(self):
		...
		"""
		if not self.allow_website_search_indexing() or nts.in_test:
			return
