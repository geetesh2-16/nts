...
if TYPE_CHECKING:
	...
	from nts.printing.doctype.print_settings.print_settings import PrintSettings
...
""",
	...
	if nts.form_dict.doc:
		...
		doc = nts.get_lazy_doc(nts.form_dict.doctype, nts.form_dict.name)
...
def get_html_and_style(
	...
	if isinstance(name, str):
		document = nts.get_lazy_doc(doc, name, check_permission=True)
	else:
		document = nts.get_doc(json.loads(doc), check_permission=True)
