...
import nts
from nts.core.doctype.data_import.importer import Importer, build_fields_dict_for_column_matching
from nts.tests import IntegrationTestCase
from nts.tests.test_query_builder import db_type_is, unimplemented_for
...
class TestImporter(IntegrationTestCase):
	...
	def test_data_import_without_label(self):
		...
		meta = nts.get_meta(doctype_name)
