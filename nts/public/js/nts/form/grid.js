...
export default class Grid {
	...
	delete_all_rows() {
		...
		nts.confirm(__("Are you sure you want to delete all {0} rows?", [num_rows]), () => {
	...
	debounced_refresh_remove_rows_button = nts.utils.debounce(
		this.refresh_remove_rows_button,
		100
	);
	...
	debounced_duplicate_rows_button = nts.utils.debounce(
		this.refresh_duplicate_rows_button,
		100
	);
