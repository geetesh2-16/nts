...
nts.search.utils = {
	...
	get_desktop_icons: function (keywords) {
		var me = this;
		var out = [];
		nts.boot.desktop_icons.forEach(function (item) {
	...
	fuzzy_search: function (keywords = "", _item = "", return_marked_string = false) {
		...
		if (score == 0 && nts.boot.lang !== "en" && item != _item) {
			item = _item || "";
	...
	/**
	 * @deprecated Use nts.search.utils.fuzzy_search(subseq, str, true).marked_string instead.
	 */
