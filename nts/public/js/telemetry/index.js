...
class TelemetryManager {
	constructor() {
		this.enabled = nts.boot.enable_telemetry || false;
		this.posthog_available = Boolean(nts.boot.telemetry_provider?.includes("posthog"));
		this.pulse_available = Boolean(nts.boot.telemetry_provider?.includes("pulse"));
