...
class UnitTestCase(unittest.TestCase, BaseTestCase):
	"""Unit test class for nts tests.

	This class extends unittest.TestCase and provides additional utilities
	specific to nts framework. It's designed for testing individual
	...
	def setUpClass(cls) -> None:
		...
		cls.module = nts.get_module(cls.__module__)
		# Test Environment
		nts.set_user("Administrator")
		# Test Environment (cleanup)
		cls.addClassCleanup(nts.set_user, "Administrator")
...
def _get_doctype_from_module(cls):
	...
	path = nts.get_pymodule_path(cls.__module__)
	try:
