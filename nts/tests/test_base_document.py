...
from nts.model.base_document import BaseDocument, _get_extended_class
...
class TestBaseDocument(IntegrationTestCase):
	...
	def test_get_extended_class_with_extensions(self):
		...
		# Mock nts.get_hooks to return extension paths
		extensions = [
			"nts.tests.test_base_document.TestExtensionA",
			"nts.tests.test_base_document.TestExtensionB",
		]
	...
	def test_extension_overrides_todo_method(self):
		...
		extensions = ["nts.tests.test_base_document.TestToDoExtension"]
	...
	def test_extension_invalid_path_raises_exception(self):
		...
		extensions = [
			"nts.tests.test_base_document.TestExtensionA",  # valid
...
def clear_todo_controller_cache():
	...
	if hasattr(nts, "controllers") and nts.local.site in nts.controllers:
		nts.controllers[nts.local.site].pop("ToDo", None)
