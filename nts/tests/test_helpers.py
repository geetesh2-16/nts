...
def create_test_blog_records():
	...
	for r in test_blog_records:
		nts.get_doc(r).insert(ignore_if_duplicate=True, ignore_links=True)
...
def setup_for_tests():
	...
	nts.delete_doc_if_exists("DocType", "Test Blog Post")
	nts.delete_doc_if_exists("DocType", "Test Blog Category")
	nts.delete_doc_if_exists("DocType", "Test Blogger")
