...
from nts.installer import _delete_doctypes
...
class TestPermissions(IntegrationTestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		setup_for_tests()
		nts.clear_cache(doctype="Test Blog Post")
	...
	def tearDown(self):
		...
		nts.db.set_value("Test Blogger", "_Test Blogger 1", "user", None)
	...
	def test_basic_permission(self):
		post = nts.get_doc("Test Blog Post", "_Test Blog Post")
	...
	def test_select_permission(self):
		...
		permitted_record = nts.get_list("Test Blog Post", fields="*", limit=1)[0]
		full_record = nts.get_all("Test Blog Post", fields="*", limit=1)[0]
	...
	def test_user_permissions_in_doc(self):
		...
		post1 = nts.get_doc("Test Blog Post", "_Test Blog Post 1")
	...
	def test_user_permissions_in_report(self):
		...
		nts.set_user("test2@example.com")
		names = [d.name for d in nts.get_list("Test Blog Post", fields=["name", "blog_category"])]

		self.assertTrue("_Test Blog Post 1" in names)
		self.assertFalse("_Test Blog Post" in names)

	def test_default_values(self):
		doc = nts.new_doc("Test Blog Post")
	...
	def test_user_link_match_doc(self):
		blogger = nts.get_doc("Test Blogger", "_Test Blogger 1")
		blogger.user = "test2@example.com"
		blogger.save()
		nts.permissions.add_user_permission("Test Blogger", blogger.name, blogger.user)

		nts.set_user("test2@example.com")

		post = nts.get_doc("Test Blog Post", "_Test Blog Post 2")
		self.assertTrue(post.has_permission("read"))
		post1 = nts.get_doc("Test Blog Post", "_Test Blog Post 1")
	...
	def test_user_link_match_report(self):
		...
		names = [d.name for d in nts.get_list("Test Blog Post", fields=["name", "owner"])]
	...
	def test_read_if_explicit_user_permissions_are_set(self):
		...
		doc = nts.get_doc("Test Blog Post", "_Test Blog Post")
		self.assertTrue(doc.has_permission("read"))

		# and not this one
		doc = nts.get_doc("Test Blog Post", "_Test Blog Post 1")
	...
	def test_set_only_once(self):
		blog_post = nts.get_meta("Test Blog Post")
		doc = nts.get_doc("Test Blog Post", "_Test Blog Post 1")
	...
	def test_set_only_once_child_table_rows(self):
		...
		doc = nts.get_doc("DocType", "Test Blog Post")
	...
	def test_user_permission_doctypes(self):
		...
		doc = nts.get_doc("Test Blog Post", "_Test Blog Post 2")
		self.assertTrue(doc.has_permission("read"))
	...
	def test_insert_if_owner_with_user_permissions(self):
		...
		nts.delete_doc("Test Blog Post", "-test-blog-post-title")
		...
		nts.set_user("Administrator")
		nts.delete_doc("Test Blog Post", "_Test Blog Post Title")
	...
	def test_strict_user_permissions(self):
		...
		local_doc = nts.copy_doc(other_contact)
	...
	def test_contextual_user_permission(self):
		...
		posts = nts.get_all("Test Blog Post", fields=["name", "blogger"])
		...
		posts = nts.get_list("Test Blog Post", fields=["name", "blogger"])
	...
	def test_if_owner_permission_overrides_properly(self):
		...
		nts.set_user("test2@example.com")
		self.assertEqual(nts.get_list("Test Blog Post"), [])
	...
	def test_if_owner_permission_on_getdoc(self):
		...
		nts.set_user("test2@example.com")
		self.assertRaises(nts.PermissionError, getdoc, "Test Blog Post", doc.name)
	...
	def test_if_owner_permission_on_get_list(self):
		...
		nts.set_user("test2@example.com")
		self.assertIn(doc.name, nts.get_list("Test Blog Post", pluck="name"))
		...
		nts.set_user("test2@example.com")
		self.assertNotIn(doc.name, nts.get_list("Test Blog Post", pluck="name"))
	...
	def test_if_owner_permission_on_delete(self):
		...
		with self.set_user("testperm@example.com"):
			...
			self.assertRaises(nts.PermissionError, nts.delete_doc, "Test Blog Post", doc.name)

		with self.set_user("test2@example.com"):
			nts.delete_doc("Test Blog Post", "_Test Blog Post Title New 1")
