...
def get_context(context):
	should_cache = not_modified_recently(nts.get_website_settings("modified"))

	website_script = nts.get_cached_doc("Website Script")
...
def get_setting(field_name):
	...
	website_settings = nts.get_website_settings(field_name)
